    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "article",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="user_feedbacks", to="article.article"
                    ),
                ),
                (
                    "feedback",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("article", "feedback", "user"), name="unique_feedback_article_by_user"
            ),
        ),
        migrations.AddConstraint(
